...
def get_patch_embed(patch_embed_cls, input_channel, img_size, patch_size, enc_embed_dim):
    assert patch_embed_cls in ['PatchEmbedDust3R', 'ManyAR_PatchEmbed']
    patch_embed = eval(patch_embed_cls)(img_size, patch_size, input_channel, enc_embed_dim)
    return patch_embed
